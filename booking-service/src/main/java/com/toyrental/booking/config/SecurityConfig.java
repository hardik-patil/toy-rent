...
public class SecurityConfig {
    ...
    /**
     * See toy-service's identical bean for the reasoning. ALLOWED_CORS_ORIGINS lets the
     * AWS deployment add its CloudFront origin without touching the local-dev default.
     */
    @Bean
